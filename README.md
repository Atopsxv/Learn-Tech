...
- Why you shouldnt use someone elses custom OS for these [reasons.](/Dont-use-customos.md)
    Instead the best solution is to create your own with [Amits PC Tuning Guide](https://github.com/amitxv/PC-Tuning) Or if its to complex use Atlas os as its used by many users [install page. (https://docs.atlasos.net/getting-started/installation/)
