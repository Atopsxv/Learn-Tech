...
- Why you shouldnt use someone elses custom OS for these [reasons.](/Dont-use-customos.md)
    Instead the best solution is to create your own with [Amits PC Tuning Guide](https://github.com/amitxv/PC-Tuning) Or if you cant follow the guide & its to complex use Atlas os [install page.](https://docs.atlasos.net/getting-started/installation/)
