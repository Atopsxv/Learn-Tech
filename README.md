...
- Use a tool called [ventoy]() to boot (multible) isos off 1 usb. Here is a [guide](https://youtu.be/EgcC_40wyKs?si=RFZxsYGy8mXAjlnI) on what is it & how to set it up. Use instead of any other iso file boot tool such as rufus as you need multiple usbs for them.
